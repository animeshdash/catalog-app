    ...
    <div>
        ...
        <select name='sort_by' id='sort_by' v-on:change='updateProducts' v-model='sortBy'>
          ...
          <div>
            ...
            <multiselect v-model='selectedCategories' :options='categories' :multiple='false' v-on:change='updateProducts'></multiselect>
          </div>
        </div>
        <div id='product_list'>
...
export default {
  ...
  data () {
    return {
      ...
      searchText: null,
      sortBy: null,
      categories: ['Mobiles', 'Electronics', 'Cosmetics', 'Books', 'Cloths'],
      selectedCategories: []
    }
  },
  methods: {
